...
#
#              for k in range(r - s):  should be s - r
#                  count = 0            count needs to be out of the range
#                  if math.cos(r) > 0:   o needs to be included because it is positive
#                      count = 1            does not add onto the previous count
#                  return count             return should be outside the range fundtion
#
...
#   2nd is wrong because it increases the x coordinate twice
#              x = starting_point.x
#              for k in range(n):
